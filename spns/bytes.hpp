...
template <>
struct hash<pns::AccountID> : pns::bytes_simple_hasher<pns::AccountID> {};
template <>
struct hash<pns::Ed25519PK> : pns::bytes_simple_hasher<pns::Ed25519PK> {};
template <>
struct hash<pns::X25519PK> : pns::bytes_simple_hasher<pns::X25519PK> {};
template <>
struct hash<pns::Blake2B_32> : pns::bytes_simple_hasher<pns::Blake2B_32> {};
...
struct formatter<T, Char, std::enable_if_t<pns::is_bytes<T>>> : fmt::formatter<std::string_view> {
