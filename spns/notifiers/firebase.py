...
# Whenever we add/change fields we increment this so that a Bchat client could figure out what it
# is speaking to:
PNS_FIREBASE_VERSION = 1
...
def push_notification(msg: Message):
    ...
    msg = messaging.Message(
        data={"enc_payload": oxenc.to_base64(enc_payload), "pns": f"{PNS_FIREBASE_VERSION}"},
        token=device_token,
