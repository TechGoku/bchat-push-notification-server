...
def subscribe():
    ...
    where CODE is one of the integer values of the pns/hive/subscription.hpp SUBSCRIBE enum.
...
def unsubscribe():
    ...
    where INT is one of the error integers from pns/hive/subscription.cpp's SUBSCRIBE enum.
