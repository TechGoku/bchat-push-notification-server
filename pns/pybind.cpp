...
struct HiveMindController {
    std::unique_ptr<pns::HiveMind> hivemind;

    HiveMindController(pns::Config conf) : hivemind{new pns::HiveMind{std::move(conf)}} {}
...
template <typename T>
struct type_caster<T, std::enable_if_t<pns::is_bytes<T>>> {
...
PYBIND11_MODULE(core, m) {
    ...
    py::class_<Config>{m, "Config"}
            ...
            .def_property(
                    "beldexd_rpc",
                    [](Config& self) { return self.beldexd_rpc.full_address(); },
                    [](Config& self, std::string addr) {
                        self.beldexd_rpc = oxenmq::address{std::move(addr)};
                    },
                    "oxenmq address of the companion beldexd RPC to use")
    ...
    py::class_<Logger>{m, "logger"}
            ...
            .def_static(
                    ...
                    "Sets/resets the log level of all pns.core log categories to the given "
                    "value.\n"
            ...
            .def_static(
                    ...
                    "Sets/resets the log level of a single pns.core log categories to the given "
                    "value.\n"
            ...
            .def_static(
                    ...
                    "Gets the log level of the given pns.core log category")
            .def_static(
                    "get_level",
                    [](const std::string& cat) { oxen::log::get_level(cat); },
                    "Gets the log level of the given pns.core log category")
            .def_static(
                    ...
                    "Gets the default log level of pns.core categories (those that have not been "
